...
call link_grants('role::gigachad',
                 array ['svc::pokemon_api::all_routes', 'svc::auth_api::all_routes', 'svc::pokemon_gamba::all_routes', 'svc::inventory_api::all_routes', 'svc::trading_api::all_routes', 'svc::leaderboards_api::all_routes', 'svc::money_manager::all_routes']);
